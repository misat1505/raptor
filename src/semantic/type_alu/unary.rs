...
impl TypeALU {
    pub(in crate::semantic) fn boolean_negate(t: Type) -> Result<Type, SemanticCheckerError> {
        match t {
    ...
    pub(in crate::semantic) fn arithmetic_negate(t: Type) -> Result<Type, SemanticCheckerError> {
        match t {
